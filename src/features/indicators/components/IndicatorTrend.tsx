...
import styles from './IndicatorTrend.module.scss'

interface IndicatorTrendProps {
  history: IndicatorHistoryPoint[]
}

export default function IndicatorTrend({ history }: IndicatorTrendProps) {
      ...
      {history.map((point, index) => {
        ...
        const barClass =
          point.value > point.baseline
            ? styles.barAboveBaseline
            : point.value < point.baseline
              ? styles.barBelowBaseline
              : styles.barValue
