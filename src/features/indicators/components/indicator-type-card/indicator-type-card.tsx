...
function averageHistory(
  ...
  const withHistory = indicators.filter(
    (i) => i.history && i.history.length > 0,
  );
...
export const IndicatorTypeCard = ({
  type,
  indicators,
      ...
      >
        <div className={styles.headerLeft}>
          <h3 className={styles.typeName}>
            ...
            {tooltipContent[type] && (
              <InfoTooltip content={tooltipContent[type]} />
            )}
          </h3>
