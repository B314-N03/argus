import { Twitter, Newspaper, MessageCircle, Globe, ChevronUp, ChevronDown } from 'lucide-react'
...
export function NewsFeed({ items, onItemClick, collapsed, onToggleCollapse }: NewsFeedProps) {
  return (
