...
function buildSvgPaths(history: { value: number }[], width: number, height: number) {
...
export function TensionIndex({ value, history }: TensionIndexProps) {
    ...
    <div className={styles.container}>
      ...
      {showChart ? (
        <div className={styles.chart}>
          <svg viewBox="0 0 300 60" preserveAspectRatio="none" className={styles.chartSvg}>
            <defs>
