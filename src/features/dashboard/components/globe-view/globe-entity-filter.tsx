...
import { AircraftCategoryFilter } from "./aircraft-category-filter";
import styles from "./globe-entity-filter.module.scss";

interface GlobeEntityFilterProps {
  filters: GlobeEntityFilters;
  categoryFilters: AircraftCategoryFilters;
  onChange: (filters: GlobeEntityFilters) => void;
  onCategoryChange: (filters: AircraftCategoryFilters) => void;
}
...
export const GlobeEntityFilter = ({
  filters,
  categoryFilters,
  onChange,
  onCategoryChange,
}: GlobeEntityFilterProps) => {
    ...
    <div className={styles.filterBar}>
      ...
      <button
        ...
        className={clsx(
          styles.filterButton,
          filters.aircraft
            ? [styles.active, styles.activeAircraft]
            : styles.inactive,
        )}
      ...
      <button
        ...
        className={clsx(
          styles.filterButton,
          filters.vessel
            ? [styles.active, styles.activeVessel]
            : styles.inactive,
        )}
      ...
      <button
        ...
        className={clsx(
          styles.filterButton,
          filters.signal
            ? [styles.active, styles.activeSignal]
            : styles.inactive,
        )}
